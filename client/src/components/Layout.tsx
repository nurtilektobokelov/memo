...
function IconSettings() {
  return (
    <svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      ...
      <path fillRule="evenodd" d="M11.865 2.126a.75.75 0 00-1.73 0l-.22 1.345a6.03 6.03 0 00-1.487.617l-1.17-.7a.75.75 0 00-.94.13L4.973 4.962a.75.75 0 00-.13.94l.7 1.17a6.031 6.031 0 00-.617 1.487l-1.345.22a.75.75 0 000 1.73l1.345.22c.14.53.35 1.03.617 1.487l-.7 1.17a.75.75 0 00.13.94l1.345 1.344a.75.75 0 00.94.13l1.17-.7c.457.267.957.477 1.487.617l.22 1.345a.75.75 0 001.73 0l.22-1.345a6.03 6.03 0 001.487-.617l1.17.7a.75.75 0 00.94-.13l1.344-1.344a.75.75 0 00.13-.94l-.7-1.17c.267-.457.477-.957.617-1.487l1.345-.22a.75.75 0 000-1.73l-1.345-.22a6.03 6.03 0 00-.617-1.487l.7-1.17a.75.75 0 00-.13-.94L15.027 4.318a.75.75 0 00-.94-.13l-1.17.7a6.03 6.03 0 00-1.487-.617l-.22-1.345zM10 6.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" clipRule="evenodd" />
    </svg>
  );
}
